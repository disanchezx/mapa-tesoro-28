// ============================================================
//  MAPA DEL TESORO · 28 AÑOS DE GRACE
//  Este es el ÚNICO archivo que hay que editar para integrar
//  mensajes nuevos. Ver COMO-AGREGAR-MENSAJES.md
// ============================================================

// ---------- MENSAJES ----------
// type: 'audio' (src = archivo en /audio o link directo a mp3/m4a)
//       'doc'   (src = link de Google Docs / Drive)
//       'pending' (aún no llega: se muestra como pendiente y no bloquea)
export const MESSAGES = {
  sol:          { name: 'Señora Sol',      relation: 'Mamá',     type: 'audio',   src: 'audio/sol.m4a' },

  sandy:        { name: 'Sandy',           relation: 'Hermana',  type: 'audio',   src: 'audio/sandy.m4a' },
  yeimi:        { name: 'Yeimi',           relation: 'Hermana',  type: 'pending', src: '' },
  monica:       { name: 'Monica',          relation: 'Hermana',  type: 'audio',   src: 'audio/monica.m4a' },
  diegoHermano: { name: 'Diego (hermano)', relation: 'Hermano',  type: 'doc',     src: 'https://docs.google.com/document/d/1m9XK8CWki8tHuOBvwaCzvslGTdoVPHsL32jm0D8_0QQ/edit?usp=drive_link' },
  milton:       { name: 'Milton',          relation: 'Hermano',  type: 'pending', src: '' },

  mariaIsabel:  { name: 'Maria Isabel',    relation: 'Amiga',    type: 'pending', src: '' },
  andres:       { name: 'Andrés',          relation: 'Amigo',    type: 'pending', src: '' },
  elizabeth:    { name: 'Elizabeth',       relation: 'Amiga',    type: 'doc',     src: 'https://docs.google.com/document/d/1KSMSFmtPrRQRD8ucZoPwQpBHu_WS5tnfEbBjkU8v_8U/edit?usp=drive_link' },

  juanEsteban:  { name: 'Juan Esteban',    relation: 'Sobrino',  type: 'audio',   src: 'audio/juan-esteban.m4a' },
  isaias:       { name: 'Isaias',          relation: 'Sobrino',  type: 'pending', src: '' },
  nicoll:       { name: 'Nicoll',          relation: 'Sobrina',  type: 'pending', src: '' },
  samuel:       { name: 'Samuel',          relation: 'Sobrino',  type: 'pending', src: '' },
  juanLucas:    { name: 'Juan Lucas',      relation: 'Sobrino',  type: 'pending', src: '' },
  naomi:        { name: 'Naomi',           relation: 'Sobrina',  type: 'pending', src: '' },
  milan:        { name: 'Milan',           relation: 'Sobrino',  type: 'pending', src: '' },
  ivan:         { name: 'Ivan',            relation: 'Sobrino',  type: 'pending', src: '' },

  diegoNovio:   { name: 'Diego',           relation: 'Tu novio', type: 'doc',     src: 'https://docs.google.com/document/d/161LHnXCCjqtF7rdQM4gguISjFFJyR0RCH7s5uRjBiIY/edit?usp=drive_link' },
};
    ...
    steps: [
      ...
      },
      {
        ...
        text: [
          ...
          'No es el hambre.',
          'No es la curiosidad.',
          'Es una sola palabra que ambos pronuncian.',
        ],
        answers: ['poke', 'poké', 'pokebowl', 'poke bowl', 'poke bol'],
        nearMisses: [
          { answers: ['por que', 'porque', 'porqué', 'po que', 'poque'], feedback: '¡Eso dice el niño! Ahora búscalo como plato en la carta 😉' },
        ],
        hints: [
  ...
  // ====================== ESTACIÓN 2 ======================
  {
    ...
    steps: [
      ...
      },
      {
        ...
        answers: ['robledo', 'talleres robledo'],
        nearMisses: [
          { answers: ['simesa', 'siderurgica de medellin'], feedback: 'Esa era la siderúrgica. Busca el nombre del taller 🔨' },
        ],
        hints: [
      ...
      },
      {
        ...
        answers: ['gonzalez', 'astrid gonzalez'],
        nearMisses: [
          { answers: ['astrid'], feedback: 'Ese es el nombre. ¡Falta el apellido!' },
        ],
        hints: [
          'Está en la Sala D.',
          'Su nombre es Astrid.',
      ...
      },
      {
        ...
        answers: ['pedro'],
        nearMisses: [
          { answers: ['gomez', 'gomez egana', 'pedro gomez egana', 'gomezegana'], feedback: 'Ese es el apellido. Te pido el nombre de pila 😉' },
        ],
        hints: [
      ...
      },
      {
        ...
        answers: ['5', 'cinco'],
        nearMisses: [
          { answers: ['250', 'doscientos cincuenta'], feedback: '¡Ese es el número de altavoces! Ahora divide entre 50 ➗' },
        ],
        hints: [
      ...
      },
      {
        ...
        answers: ['ggb', 'g g b'],
        nearMisses: [
          { answers: ['ggf', 'agf', 'apf', 'apb', 'agb'], feedback: 'Casi: usa siempre el APELLIDO de cada artista.' },
        ],
        hints: [
      ...
      },
      {
        ...
        answers: ['3', 'tres'],
        nearMisses: [
          { answers: ['4', '5', 'cuatro', 'cinco'], feedback: 'Revisa bien: los sinónimos no cuentan 🧐' },
        ],
        hints: [
      ...
      },
      {
        ...
        answers: ['argote', 'ivan argote'],
        nearMisses: [
          { answers: ['ivan'], feedback: '¡Ese es el nombre! Ahora el apellido.' },
        ],
        hints: [
      ...
      },
      {
        ...
        hints: {
          ...
          4: 'Queda muy cerca del museo.',
          6: 'Capa que protege el grano de café antes de tostarlo.',
        },
  ...
  // ====================== ESTACIÓN 3 ======================
  {
    ...
    steps: [
      ...
      },
      {
        ...
        answers: ['bautizo', 'bautismo', 'mi bautizo', 'mi bautismo', 'bautizado', 'bautizada'],
        hints: [
          'Fue en una iglesia.',
      ...
      },
      {
        ...
        answers: ['niño dios', 'ninodios', 'el niño dios', 'niño diosito', 'divino niño', 'niño jesus', 'el niño jesus'],
        contains: ['nino dios', 'ninodios'],
        nearMisses: [
          { answers: ['papa noel', 'santa', 'santa claus', 'papa noel'], feedback: 'Aquí en Colombia no trae los regalos él 🎅❌' },
        ],
        hints: [
      ...
      },
      {
        ...
        answers: ['diego', 'mi novio', 'diego sanchez'],
        contains: ['diego'],
      ...
      {
        // TODO DIEGO: puzzle 5 de pareja. Llenar texto + respuestas y poner enabled: true
        type: 'riddle',
        id: 'e3-pareja',
        enabled: false,
      ...
      },
      {
        ...
        keyword: 'SIEMPRE',
        rows: [
          { answer: 'ESTRUCTURA', key: 1, clue: 'Esqueleto que sostiene un edificio (ingeniería civil).' },
          { answer: 'VIGA',       key: 1, clue: 'Elemento horizontal que resiste la flexión.' },
          { answer: 'PERGAMINO',  key: 1, clue: 'El lugar donde estás sentada ahora mismo.' },
          // TODO DIEGO: palabra personal con M (clave en la posición `key`, empezando en 0)
          { answer: 'MEDELLIN',   key: 0, clue: 'La ciudad donde hoy celebras tus 28.' },
          { answer: 'POKE',       key: 0, clue: 'El plato que habla como un niño preguntón.' },
          { answer: 'CONCRETO',   key: 4, clue: 'Cemento + arena + grava + agua.' },
          // TODO DIEGO: palabra personal de ustedes dos con E
          { answer: 'TEAMO',      key: 1, clue: 'Lo que te digo todos los días (dos palabras, juntas).' },
        ],
